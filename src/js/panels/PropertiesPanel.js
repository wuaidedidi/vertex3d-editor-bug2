...
const PropertiesPanel = (() => {
  ...
  function _applyTransformFromInput(input) {
    ...
    switch (prop) {
      case "px":
        currentObject.position.x = val;
        break;
      case "py":
        currentObject.position.y = val;
        break;
      case "pz":
        currentObject.position.z = val;
        break;
      case "rx":
        currentObject.rotation.x = THREE.MathUtils.degToRad(val);
        break;
      case "ry":
        currentObject.rotation.y = THREE.MathUtils.degToRad(val);
        break;
      case "rz":
        currentObject.rotation.z = THREE.MathUtils.degToRad(val);
        break;
      case "sx":
        currentObject.scale.x = val;
        break;
      case "sy":
        currentObject.scale.y = val;
        break;
      case "sz":
        currentObject.scale.z = val;
        break;
    }
