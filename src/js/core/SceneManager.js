...
const SceneManager = (() => {
    ...
    function setViewAngle(direction) {
        ...
        switch (direction) {
            case 'front': newPos = new THREE.Vector3(0, 0, -distance); break;
            case 'back': newPos = new THREE.Vector3(0, 0, distance); break;
            case 'right': newPos = new THREE.Vector3(-distance, 0, 0); break;
            case 'left': newPos = new THREE.Vector3(distance, 0, 0); break;
            case 'top': newPos = new THREE.Vector3(0, distance, 0.001); break;
            case 'bottom': newPos = new THREE.Vector3(0, -distance, 0.001); break;
            default: return;
        }
    ...
    function getOrbitControls() { return orbitControls; }
    function getTransformControls() { return transformControls; }
    function getSceneObjects() { return sceneObjects; }
    function getCanvas() { return canvas; }
    function isSnapEnabled() { return snapEnabled; }
    function getIsPerspective() { return isPerspective; }
    function getIsWireframe() { return isWireframe; }
    ...
    return {
        ...
        attachTransformControls, setTransformMode,
        toggleProjection, setViewAngle, focusSelected,
        toggleWireframe, toggleGrid, toggleSnap,
        getScene, getCamera, getRenderer,
        getOrbitControls, getTransformControls,
        getSceneObjects, getCanvas,
        isSnapEnabled, getIsPerspective, getIsWireframe
    };
})();
